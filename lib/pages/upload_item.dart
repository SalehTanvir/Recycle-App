           ...
           child: Row(
             children: [
              ...
              SizedBox(width: MediaQuery.of(context).size.width/5 ,),
               Text("Upload Item", style: AppWidget.headlinetextstyle(20.0),),
             ],
           ),
         ),
         SizedBox(height: 20.0,),
          Expanded(
            child: Container(
              ...
              decoration: BoxDecoration(borderRadius: BorderRadius.only(topLeft: Radius.circular(30), topRight: Radius.circular(30)),color: Color.fromARGB(255, 227, 227, 249)),
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text("Enter Your Address you want the item to be picked.", style: AppWidget.normaltextstyle(20.0),),
                  ),
                  ...
                  Padding(
                    padding: const EdgeInsets.only(left: 20.0,right: 20.0),
                    child: Text("Enter the Quantity of the item to be picked", style: AppWidget.normaltextstyle(20.0),),
                  ),
                  SizedBox(height: 10.0,),
                  Container(
                     margin: EdgeInsets.only(left: 20.0, right: 20.0),
